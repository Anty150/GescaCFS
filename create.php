    ...
    <div class="content">
        <div class="form">
            <form action="create.php" method="POST">
                <label for="textName">Name</label><input type="text" name="textName" id="textName">
                </br>
                <label for="textFieldName">Fieldname</label><input type="text" name="textFieldName" id="textFieldName">
                </br>
